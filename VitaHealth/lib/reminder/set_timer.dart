...
class _SetTimeState extends State<SetTime> {
  ...
  Widget build(BuildContext context) {
    ...
    void _selectTime() async {
      ...
      flutterTts.speak('Wake up! It is time to start your day.');
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("VitaHealth", style: mainHeading,),
        centerTitle: true,
        toolbarHeight: 80,
        elevation: 0,
      ),
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextButton(child: Text("Done", style: const TextStyle(color: Colors.black),), onPressed: (){
                  ...
                  FlutterAlarmClock.createAlarm(14, 02, title: "11mg/ml of Aspirin");
